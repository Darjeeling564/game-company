 ...
 * **キャラの区切り（300 / 225 / 180）を支援カードにそのまま当てると全部コモンになる。**
 * 支援側の区切りは、キャラの区切りから HP の平均ぶん 110 を引いた
 * 190 / 115 / 60 を使う。同じ強さなら同じレアリティになる、という対応を保つため。
 */
const CREATURE_BANDS: readonly (readonly [number, Rarity])[] = [
  [300, 'ultra'], [225, 'superRare'], [180, 'rare'],
]
