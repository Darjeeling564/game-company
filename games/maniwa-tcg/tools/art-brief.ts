 ...
 * 2026-09-20 にさらに緩め、最終的に**裸体の描写そのものを判定から外した**。
 * 乳首・乳輪・陰毛・性器のいずれも可否に関係しない。
 * **残った判定は「人物が成人に見えるか」だけ**である。
 * 覆いで弾く項目が無くなったぶん、年齢の判定がそのまま唯一の歯止めになる。
...
const COSTUME_NOTE: readonly string[] = [
  '**人物が成人に見えること。** 取り込めるかどうかはこの1点で決まる（2026-09-20）',
  '**裸体の描写は判定に使わない。** 乳首・乳輪・陰毛・性器、どれが描かれていても通る',
  '覆いの有無・形・素材・面積は問わない。覆いが無いものも通る',
