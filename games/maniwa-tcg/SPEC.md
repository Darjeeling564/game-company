...
属性を3種（炎・草・水）＋無色から、**8種＋無**に広げる案。
**本章は提案であり、Q13〜Q17 の承認を得るまで実装に着手しない**（CLAUDE.md 7章）。
...
| 種別 | 現在 | 目標 |
|---|---|---|
| 属性キャラ | 36（炎12 / 森12 / 水12） | **64**（8属性 × 8） |
| 無キャラ | 4 | **8** |
| キャラ合計 | 40 | **72** |

16.6 で決めた「キャラ64種」は、無を別枠にして **72種**に読み替える。
属性の拡張とキャラの量産は、同じ作業としてまとめて行うのが自然。

### 17.6 これは相性の偏りの対策にはならない
