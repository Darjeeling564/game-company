...
const FIRE: readonly CardDef[] = [
  {
    ...
    type: 'fire', hp: 80, ex: false, retreatCost: 1, weakness: 'grass', stage: 0,
    attacks: [
  ...
  },
  {
    ...
    type: 'fire', hp: 90, ex: false, retreatCost: 1, weakness: 'grass', stage: 0,
    attacks: [
  ...
  },
  {
    ...
    type: 'fire', hp: 130, ex: false, retreatCost: 2, weakness: 'grass', stage: 0,
    attacks: [
  ...
  },
  {
    ...
    type: 'fire', hp: 120, ex: false, retreatCost: 2, weakness: 'grass', stage: 0,
    attacks: [
  ...
  },
  {
    ...
    type: 'fire', hp: 180, ex: true, retreatCost: 2, weakness: 'grass', stage: 0,
    attacks: [
